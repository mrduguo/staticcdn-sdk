...
def assertFileOptimized(File expectedOptimizedFile) {
    if (!expectedOptimizedFile.text.equals('<html> <head> <title>test</title> </head> <body> test </body> </html>')) {
        throw new RuntimeException("unexpected optimized content $expectedOptimizedFile.text")
    }
}
